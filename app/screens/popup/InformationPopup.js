        ...
        <Modal
            ...
            <ModalContent style={[appStyles.popup, popupStyle]}>
                ...
                {buttons.length > 1 ? <CBView style={[appStyles.row, {justifyContent: 'space-between', marginTop: 15}]} define={'none'}>
                    <CBButton style={{width: buttonWith}} type={'outline'} title={buttons[0] && buttons[0].text ? buttons[0].text : ''} onPress={onPress(0)}/>
                    <CBButton style={{width: buttonWith}} title={buttons[1] && buttons[1].text ? buttons[1].text : ''} onPress={onPress(1)}/>
