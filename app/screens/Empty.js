        ...
        return (
            <CBContainer>
                ...
                <CBView style={appStyles.body} define={'none'}>
                    <CBText style={appStyles.title} define={'title'}>{strings('text_opps')}</CBText>
                ...
                <CBView style={appStyles.footer} define={'none'}>
                    <CBButton buttonStyle={[appStyles.border, {width}]} type={'outline'} title={strings('button_home')} onPress={this.goHome}/>
                    <CBButton buttonStyle={[appStyles.border, {width}]} title={strings('button_update')} onPress={this.onUpdate}/>
                </CBView>
            </CBContainer>
        );
    }
