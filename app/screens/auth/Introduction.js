        ...
        return (
            <CBContainer>
                ...
                <CBView style={[appStyles.column, {flex: 1, justifyContent: 'space-between'}]} define={'none'}>
                    <View style={{height: 8}}/>
                    <CBButton buttonStyle={[appStyles.border, appStyles.circle]} icon={<CBIcon type={'feather'} name={index < introductions.length - 1 ? 'arrow-right' :  'check'} color={'#FFFFFF'} size={25}/>} onPress={this.onNextOrStart}/>
